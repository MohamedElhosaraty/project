class Product {
  ...
  Product(
   ...
   Product(
       ...
       price: 1000,
       title: 'Smart Watch',
       subtitle: 'New luxury 4G wifi smartwatch Lokmat applp 3 pro with 5mp GPS camera,'
           ' long life battery, Android smartwatch with Sim',
       image: 'assets/smartwatch.jpg',
       description: """chronograph, calendar, alarm clock, week, month, world time,
    ...
    Product(
        ...
        price: 700,
        title: 'Air Headphone',
        subtitle: 'New Product Tws K55 Earbuds Wireless Gaming Headphones 49 Hifi 9d Stereo Headphones with Microphone for Gamers',
